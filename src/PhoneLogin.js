    ...
    <div className="PhoneLogin">
      ...
      {isCodeSent ? 
        <div>
          ...
          <input className="textx" type="text" value={verificationCode} onChange={(e) => setVerificationCode(e.target.value)} />
        ...
        <div>
          ...
          <input className="textx" type="text" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
